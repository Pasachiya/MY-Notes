...
const Home = () => {
    ...
    const getAllNotes = async () => {
        try{
            ...
            console.log("An unexpected error pccurred. Please try again.")
        }
    }
    ...
    const updateIsPinned = async (notData) => {
        const noteId = notData._id
        try{
            const response = await axiosInstance.put("/update-note-pinned/" + noteId,{
                "isPinned": !notData.isPinned,
            });
